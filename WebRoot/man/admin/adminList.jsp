...
<html>
	...
	<body>
		...
		<div class="dx-operation-bar">
			<div class="col-lg-12">
				<button type="button" onclick="adminAdd()" class="man-btn man-btn-100">添加</button>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default  wk-panel">
					...
					<pg:param name="type" value="adminMana" />
						...
						<tbody>
							<c:forEach items="${adminList}" var="admin" varStatus="status">
								...
								<tr>
									...
									<td>
										<a class="man-btn btn-blue btn-xs" href="<%=path%>/toadminEdit.action?id=${admin.id}">
											编辑
										</a>
										<a class="man-btn btn-red btn-xs" onclick="adminDel('${admin.id}')">
											删除
										</a>	
									</td>
								</tr>

		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default wk-panel " style="overflow: hidden;">
					...
					<form action="<%=path%>/xiangmuEdit.action" name="formAdd"
						method="post">
						<div class="panel-body" style="float: left; width: 600px;">
							<input name="id" type="hidden" value="${xiangmu.id}" />
								...
								<div>
									...
									<div class="input-group" style="width:450px">
										<input required="required" name="name" type="text"
											class="form-control wk-normal-input" value="${xiangmu.name}"/>
									</div>
								</div>
								...
								<div>
									...
									<div class="input-group" style="width:450px">
										<textarea required="required" name="miaoshu"  rows="6"
											class="form-control wk-normal-input" placeholder="请输入描述信息">${xiangmu.miaoshu}</textarea>
									</div>
								</div>

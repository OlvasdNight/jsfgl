		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default wk-panel " style="overflow: hidden;">
					...
					<form action="<%=path%>/coachInfo.action" name="formAdd"
						method="post" >
						<div class="panel-body" style="float: left; width: 600px;">
							...
							<input name="state" type="hidden" value="${coach.state}"/>
							...
							<div class="form-inline">
								<div>
									...
									<div class="input-group" style="width: 340px">
										<input readonly="readonly" name="uname" type="text" value="${coach.uname}"
